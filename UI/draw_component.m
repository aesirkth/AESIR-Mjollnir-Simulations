...
cellfun(@(moment) quiver3(ax, ...
                         comp.position(1) + comp.attitude(1,:)*moment.pos - moment.vec(1)*scaler*100, ...
                         comp.position(2) + comp.attitude(2,:)*moment.pos - moment.vec(2)*scaler*100, ...
                         comp.position(3) + comp.attitude(3,:)*moment.pos - moment.vec(3)*scaler*100, ...
                         moment.vec(1)*scaler*100, ...
                         moment.vec(2)*scaler*100, ...
                         moment.vec(3)*scaler*100, ...
                         "Color", ColorMap(60,:), ...
                         "LineWidth", 1.5),...
         values(comp.moments , "cell"))
