...
patch(ax, new_mesh, 'FaceColor',       ColorMap(70,:), ...
                    ...
                    'AmbientStrength', 0.1, ...
                    'FaceAlpha',       0.7);
%l = light(ax, "Style","local","comp.position", comp.position' + [1 0 0]);
l = light(ax);
l.Color = [1 1 1];
lighting(ax, "flat")
axis(ax, "tight")
...
quiver3(ax, comp.position(1) + comp.attitude(1,:)*comp.center_of_mass, ...
            comp.position(1) + comp.attitude(1,:)*comp.center_of_mass, ...
            comp.position(1) + comp.attitude(1,:)*comp.center_of_mass, ...
            comp.guidance.desired_direction(1)*10,...
            comp.guidance.desired_direction(2)*10,...
            comp.guidance.desired_direction(3)*10, "LineWidth", 2);
text   (ax, comp.position(1) + comp.attitude(1,:)*comp.center_of_mass + comp.guidance.desired_direction(1)*5, ...
            comp.position(1) + comp.attitude(1,:)*comp.center_of_mass + comp.guidance.desired_direction(2)*5, ...
            comp.position(1) + comp.attitude(1,:)*comp.center_of_mass + comp.guidance.desired_direction(3)*5, "desired direction");
