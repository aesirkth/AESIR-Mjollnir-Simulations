...
moment_of_area(face, dimension, 1) = pixel_height*sum( height2width(height_vec).*((height_vec - rocket.rigid_body.center_of_mass(dimension))   ), "all");
moment_of_area(face, dimension, 2) = pixel_height*sum( height2width(height_vec).*((height_vec - rocket.rigid_body.center_of_mass(dimension)).^2), "all");
moment_of_area(face, dimension, 3) = pixel_height*sum( height2width(height_vec).*((height_vec - rocket.rigid_body.center_of_mass(dimension)).^3), "all");
moment_of_area(face, dimension, 4) = pixel_height*sum( height2width(height_vec).*((height_vec - rocket.rigid_body.center_of_mass(dimension)).^4), "all");
...
moment_of_area(face, dimension, 1) = pixel_width*sum( width2height(width_vec ).*((width_vec - rocket.rigid_body.center_of_mass(dimension))    ), "all");
moment_of_area(face, dimension, 2) = pixel_width*sum( width2height(width_vec ).*((width_vec - rocket.rigid_body.center_of_mass(dimension)) .^2), "all");
moment_of_area(face, dimension, 3) = pixel_width*sum( width2height(width_vec ).*((width_vec - rocket.rigid_body.center_of_mass(dimension)) .^3), "all");
moment_of_area(face, dimension, 4) = pixel_width*sum( width2height(width_vec ).*((width_vec - rocket.rigid_body.center_of_mass(dimension)) .^4), "all");
...
% scatter(temp_ax2, rocket.rigid_body.center_of_mass(dimension), 1);
