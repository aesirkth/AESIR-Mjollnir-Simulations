...
if comp.active_burn_flag == 0
    ...
    [comp.T_ext_COESA, comp.speed_of_sound, comp.P_ext, comp.rho_ext] = atmoscoesa(comp.position(3));
    ...
    comp.forces.Thrust = force(F*comp.attitude*[0;0;1],[0;0;-0.9]);
    ...
    comp.forces.Thrust = force([0;0;0],[0;0;-0.9]);
