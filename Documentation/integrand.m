...
integrand_line1 = animation(@(c) plot3(r, y, 0.1*sign(c{1} - c{2}.*r).*(c{1} - c{2}.*r).^2, "LineWidth", 1.2, "Color", [1,0.5,0]), {0,1}, {10,0} );
integrand_line2 = animation(@(c) plot3(r, y, 0.1*sign(c{1} - c{2}.*r).*(c{1} - c{2}.*r).^2, "LineWidth", 1.2, "Color", [1,0.5,0]), {10,0}, {5,1} );
integrand_line3 = animation(@(c) plot3(r, y, 0.1*sign(c{1} - c{2}.*r).*(c{1} - c{2}.*r).^2, "LineWidth", 1.2, "Color", [1,0.5,0]), {5,1}, {-5,1} );
integrand_line4 = animation(@(c) plot3(r, y, 0.1*sign(c{1} - c{2}.*r).*(c{1} - c{2}.*r).^2, "LineWidth", 1.2, "Color", [1,0.5,0]), {-5,1}, {-5,-1} );
integrand_line5 = animation(@(c) plot3(r, y, 0.1*sign(c{1} - c{2}.*r).*(c{1} - c{2}.*r).^2, "LineWidth", 1.2, "Color", [1,0.5,0]), {-5,-1}, {0,1} );
...
text1 = animation(@(c) text(r_text, y_text, 0.1*sign(c{1} - c{2}.*r_text).*(c{1} - c{2}.*r_text).^2 + 5,"$(v_0 - \omega r)^2 \cdot sign(v_0 - \omega r) b(r) $", "Interpreter", "latex", "Color", [1,0.5,0]), {0,1}, {10,0} );
text2 = animation(@(c) text(r_text, y_text, 0.1*sign(c{1} - c{2}.*r_text).*(c{1} - c{2}.*r_text).^2 + 5,"$(v_0 - \omega r)^2 \cdot sign(v_0 - \omega r) b(r) $", "Interpreter", "latex", "Color", [1,0.5,0]), {10,0}, {5,1} );
text3 = animation(@(c) text(r_text, y_text, 0.1*sign(c{1} - c{2}.*r_text).*(c{1} - c{2}.*r_text).^2 + 5,"$(v_0 - \omega r)^2 \cdot sign(v_0 - \omega r) b(r) $", "Interpreter", "latex", "Color", [1,0.5,0]), {5,1}, {-5,1} );
text4 = animation(@(c) text(r_text, y_text, 0.1*sign(c{1} - c{2}.*r_text).*(c{1} - c{2}.*r_text).^2 + 5,"$(v_0 - \omega r)^2 \cdot sign(v_0 - \omega r) b(r) $", "Interpreter", "latex", "Color", [1,0.5,0]), {-5,1}, {-5,-1} );
text5 = animation(@(c) text(r_text, y_text, 0.1*sign(c{1} - c{2}.*r_text).*(c{1} - c{2}.*r_text).^2 + 5,"$(v_0 - \omega r)^2 \cdot sign(v_0 - \omega r) b(r) $", "Interpreter", "latex", "Color", [1,0.5,0]), {-5,-1}, {0,1} );
