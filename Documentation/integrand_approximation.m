...
approx_text1 = animation(@(c) text(r_text+10, y_text, f2(r_text+10,c{1}, c{2}) + 5,"$(v_0 - \omega r)^3 |v_0 - \omega r_{ref}|^{-1} b(r) $", "Interpreter", "latex", "Color", [0 1 1]), {0,1}, {10,0} );
approx_text2 = animation(@(c) text(r_text+10, y_text, f2(r_text+10,c{1}, c{2}) + 5,"$(v_0 - \omega r)^3 |v_0 - \omega r_{ref}|^{-1} b(r) $", "Interpreter", "latex", "Color", [0 1 1]), {10,0}, {5,1} );
approx_text3 = animation(@(c) text(r_text+10, y_text, f2(r_text+10,c{1}, c{2}) + 5,"$(v_0 - \omega r)^3 |v_0 - \omega r_{ref}|^{-1} b(r) $", "Interpreter", "latex", "Color", [0 1 1]), {5,1}, {-5,1} );
approx_text4 = animation(@(c) text(r_text+10, y_text, f2(r_text+10,c{1}, c{2}) + 5,"$(v_0 - \omega r)^3 |v_0 - \omega r_{ref}|^{-1} b(r) $", "Interpreter", "latex", "Color", [0 1 1]), {-5,1}, {-5,-1} );
approx_text5 = animation(@(c) text(r_text+10, y_text, f2(r_text+10,c{1}, c{2}) + 5,"$(v_0 - \omega r)^3 |v_0 - \omega r_{ref}|^{-1} b(r) $", "Interpreter", "latex", "Color", [0 1 1]), {-5,-1}, {0,1} );
...
delete integrand_approximation.gif
saver =  save_to_gif(ax, "integrand_approximation.gif");
