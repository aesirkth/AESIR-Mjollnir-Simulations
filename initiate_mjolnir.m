...
mjolnir.engine.fuel_grain.radius_margin = sqrt(mjolnir.engine.combustion_chamber.internal_diameter^2 / 4 - mjolnir.engine.fuel_grain.mass_margin / (mjolnir.engine.fuel_grain.density * mjolnir.engine.fuel_grain.length * pi));
